...
class BmindFastBonus extends Command
{
    protected $signature = 'bmind:fast-bonus';
    protected $description = 'Fast BMIND Daily Bonus Cron';
    ...
    public function handle()
    {
        try {
            ...
            PurchaseStaking::where('wallet', 'BMIND')
                ->where('status', 1)
                        ...
                        try {
                            ...
                            if ($received < $duration) {
                                ...
                                Transaction::create([
                                    ...
                                    'type'        => 'Credit',
                                    'status'      => 'Approved',
                                    'description' => $row->daily . ' BMIND Daily Bonus',
                                ]);
                                ...
                                if ($user->sponsor_id) {
                                    ...
                                    if ($sponsor && $row->seller_bonus_rate > 0) {
                                        ...
                                        Transaction::create([
                                            ...
                                            'description'   => $sellerBonus . ' BMIND Seller Bonus',
                                        ]);
                                    }
                                }
                            ...
                            // =====================
                                ...
                                if ($row->status == 1) {
                                    ...
                                    Transaction::create([
                                        ...
                                        'type'        => 'Credit',
                                        'status'      => 'Approved',
                                        'description' => $row->amount . ' BMIND Settlement',
                                    ]);
